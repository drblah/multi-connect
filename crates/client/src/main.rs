...
fn main() {
    ...
    smol::block_on(Compat::new(async {
        ...
        let mut connection_manager = connection_manager::ConnectionManager::new(client_socket_address, client_id, client_tun_ip, static_routes, settings.connection_timeout);
